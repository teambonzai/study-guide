const MAPS = [
 ...
 {title:"2 · Sticking and climbing", html:`<div class="flow">
   ...
   <div class="frow" style="align-items:flex-start;gap:22px">
     <div class="flow" style="gap:6px">
       ${n(C['cohesion'].color,"Cohesion","water to water")}${down('alone causes')}${n(C['surface'].color,"Surface tension","a water strider stands on water")}
     </div>
     <div class="flow" style="gap:6px">
 ...
 {title:"3 · Specific heat: fast vs. slow", html:`<div class="flow">
   ...
   <div class="frow" style="align-items:flex-start;gap:22px">
     <div class="flow" style="gap:6px">
       ${n('#ea580c',"Low: copper, aluminum","little energy needed")}${down('so they')}${n('#ea580c',"Warm up fast","and cool down fast")}
     </div>
     <div class="flow" style="gap:6px">
       ${n('#0284c7',"High: water","lots of energy needed")}${down('so it')}${n('#0284c7',"Warms up slowly","keeps temperatures steady")}
     </div>
   </div>
 </div>`}
];
